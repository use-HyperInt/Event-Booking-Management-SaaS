...
exports.checkUserExists = exports.getUserProfile = exports.registerUser = void 0;
...
const registerUser = async (req, res) => {
    try {
        ...
        const { error } = schema_1.userRegistrationSchema.validate(req.body);
        if (error) {
        ...
        const existingUser = await userprof_model_1.default.findOne({ firebaseUid: decodedToken.uid });
        if (existingUser) {
        ...
        const user = new userprof_model_1.default(userData);
